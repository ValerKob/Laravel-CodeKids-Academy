...
@section('title', 'ИИ Уровень (Junior) - Code Kids Academy -  Дополнительное Образование')
...
<section class="hero-pattern py-12 md:py-20">
  ...
  >
    ...
    <div class="md:w-1/2 flex justify-center">
      <img
        src="./../assets/images/pages/ai_junior.jpg"
      ...
      <div class="lg:w-2/3">
        ...
        <div class="mb-12">
          ...
          <p class="text-lg mb-6">
            Курс «ИИ Уровень (Junior)» создан для самых юных учеников 7–9
            лет, чтобы в игровой и понятной форме познакомить их с миром
            искусственного интеллекта. Мы объясняем сложные вещи простыми
            словами и показываем, как ИИ помогает в жизни — от голосовых
            помощников до умных машин.
          </p>
          <p class="text-lg">
            Каждое занятие — это весёлое путешествие в технологии будущего,
            где дети сами создают простые ИИ-проекты с помощью визуальных
            сред и интерактивных заданий.
          </p>
        </div>
          ...
          <div class="grid md:grid-cols-2 gap-4">
            ...
            >
              ...
              <p class="text-gray-600 dark:text-gray-300">
                Рассмотрим на примерах, где он встречается в жизни
              </p>
            </div>
            <div
              class="p-5 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700"
            >
              ...
              <p class="text-gray-600 dark:text-gray-300">
                Простыми словами объясним основы машинного обучения и логики
              </p>
              <p></p>
            </div>
            ...
            >
              ...
              <p class="text-gray-600 dark:text-gray-300">
                Работа с платформами, где не нужно писать код, а можно
                собирать логику из блоков
              </p>
            </div>
            <div
              class="p-5 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700"
            >
              ...
              <p class="text-gray-600 dark:text-gray-300">
                Игра с умным соперником или мини-программа, реагирующая на
                действия
              </p>
            </div>
            <div
            ...
            >
              ...
              <p class="text-gray-600 dark:text-gray-300">
                Каждый ученик создаёт свой первый проект с элементами
    ...
    <div class="space-y-6">
          ...
          <div class="inner p-0">
            ...
            <ul class="space-y-3">
              <li class="flex items-center">
                ...
                <span class="text-gray-400">Как работать с ИИ?</span>
              </li>
              <li class="flex items-center">
                <div
                  class="w-6 h-6 flex items-center justify-center bg-gray-200 text-gray-500 rounded-full mr-3"
                ...
                <span class="text-gray-400">Как нейросеть нас понимает?</span>
              </li>
              <li class="flex items-center">
                <div
                  class="w-6 h-6 flex items-center justify-center bg-gray-200 text-gray-500 rounded-full mr-3"
                ...
                <span class="text-gray-400">Учимся писать Промты для ИИ. (GigaChat, Deepseek, ChatGpt)</span>
              </li>
              <li class="flex items-center">
                <div
                  class="w-6 h-6 flex items-center justify-center bg-gray-200 text-gray-500 rounded-full mr-3"
                ...
                <span class="text-gray-400"
                  >Создаём свои первые картинки.</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400">Учимся совмещать картинки и генерация текста.</span>
              </li>
              <li class="flex items-center">
                <div
                  class="w-6 h-6 flex items-center justify-center bg-gray-200 text-gray-500 rounded-full mr-3"
      ...
      <div class="border border-gray-200 rounded-lg p-4">
        <div class="flex justify-between items-start">
          <div>
            <h3 class="font-semibold">
              Модуль 2: Создай. Настрой. Вставь.
            </h3>
            <p class="text-sm text-gray-600 dark:text-gray-100">
              6 уроков • 6 часов
            </p>
          ...
          <div class="inner p-0">
            ...
            <ul class="space-y-3">
              <li class="flex items-center">
                ...
                <span class="text-gray-400"
                  >Создаём простаю игру с ИИ.</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400">Добавляем картинки с в игру.</span>
              </li>
              <li class="flex items-center">
                <div
                  class="w-6 h-6 flex items-center justify-center bg-gray-200 text-gray-500 rounded-full mr-3"
                ...
                <span class="text-gray-400">Создаём звук для персонажей.</span>
              </li>
              <li class="flex items-center">
                <div
                  class="w-6 h-6 flex items-center justify-center bg-gray-200 text-gray-500 rounded-full mr-3"
              ...
              <li class="flex items-center">
                ...
                <span class="text-gray-400">Делаем 3Д модели в ИИ.</span>
              </li>
              <li class="flex items-center">
                <div
                  class="w-6 h-6 flex items-center justify-center bg-gray-200 text-gray-500 rounded-full mr-3"
          ...
          <div class="inner p-0">
            ...
            <ul class="space-y-3">
              <li class="flex items-center">
                ...
                <span class="text-gray-400"
                  >Основы в программирование.</span
                >
              </li>
              <li class="flex items-center">
                <div
              ...
              <li class="flex items-center">
                ...
                <span class="text-gray-400"
                  >Нейросети для визуального оформления</span
                >
              </li>
               <li class="flex items-center">
                <div
          ...
          <div class="inner p-0">
            ...
            <ul class="space-y-3">
              <li class="flex items-center">
                ...
                <span class="text-gray-400"
                  >Атмосфера игры: стиль и цвет.</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Анимация и озвучка сцен с помощью ИИ.</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Работа с задним планом в игре.</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Генерация видео с помощью ИИ.</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400">Финальная сборка проекта</span>
              </li>
              <li class="flex items-center">
                <div
                  class="w-6 h-6 flex items-center justify-center bg-gray-200 text-gray-500 rounded-full mr-3"
