...
@section('title', 'Разработка игр на Unity (Middle) - Code Kids Academy -  Дополнительное Образование')
...
<section class="hero-pattern py-12 md:py-20">
  ...
  >
    ...
    <div class="md:w-1/2 flex justify-center">
      <img
        src="./../assets/images/pages/unity_middle.jpg"
      ...
      <div class="lg:w-2/3">
        ...
        <div class="mb-12">
          ...
          <p class="text-lg mb-6">
            Этот курс подойдет тем, кто уже имеет базовое представление о
            создании игр и хочет углубиться в профессиональную разработку на
            игровом движке Unity. Ребята научатся создавать полноценные 2D и
            3D игры, использовать физику, анимацию, звуки и писать код на
            языке C#.
          </p>
          <p class="text-lg">
            Мы учим через практику — от простых механик до создания
            собственного игрового проекта.
          </p>
        </div>
        ...
        <div class="mb-12">
          ...
          <div class="grid md:grid-cols-2 gap-4">
            ...
            >
              ...
              <p class="text-gray-600 dark:text-gray-300">
                Создание логики игры: управление персонажем, счёт, уровни и
                т.д.
              </p>
              <p></p>
            </div>
            ...
            >
              ...
              <p class="text-gray-600 dark:text-gray-300">
                Добавление спрайтов, 3D-моделей, освещения и камеры
              </p>
            </div>
            <div
              class="p-5 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700"
            >
              ...
              <p class="text-gray-600 dark:text-gray-300">
                Меню, жизни, таймеры, переходы между уровнями
              </p>
            </div>
            <div
              class="p-5 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700"
            >
              ...
              <p class="text-gray-600 dark:text-gray-300">
                Оживляем игру с помощью эффектов и движений
              </p>
            </div>
            <div
              class="p-5 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700"
  ...
  >
    ...
    <div class="space-y-6">
            ...
            <ul class="space-y-3">
              <li class="flex items-center">
                ...
                <span class="text-gray-400"
                  >Знакомство с GameLab: интерфейс и рабочее пространство.</span
                >
              </li>
              <li class="flex items-center">
                <div
      ...
      <div class="border border-gray-200 rounded-lg p-4">
        <div class="flex justify-between items-start">
          <div>
            <h3 class="font-semibold">Модуль 2: Программирование на C#. Даа, это си-шарп друг мой.</h3>
            <p class="text-sm text-gray-600 dark:text-gray-100">
              5 уроков • 5 часов
            </p>
          </div>
          ...
          <div class="inner p-0">
            ...
            <ul class="space-y-3">
              <li class="flex items-center">
                ...
                <span class="text-gray-400"
                  >C# - кто это? Синтаксис и особенности.</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Работа с переменными и типами данных. Int, Float, String, Bool.</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Поведение персонажей и объектов, работа функцией.</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Главные помошники в ООП, Создание классов.</span
                >
              </li>
              <li class="flex items-center">
                <div
      ...
      <div class="border border-gray-200 rounded-lg p-4">
        <div class="flex justify-between items-start">
          <div>
            <h3 class="font-semibold">Модуль 3: 3D-дизайн уровней. Да тут мы с тобой делаем игру)</h3>
            <p class="text-sm text-gray-600 dark:text-gray-100">
              5 уроков • 5 часов
            </p>
          </div>
          ...
          <div class="inner p-0">
            ...
            <ul class="space-y-3">
              ...
              <li class="flex items-center">
                ...
                <span class="text-gray-400"
                  >Занимаемся детализацией карты. Добавляем различные объекты из библиотеки.</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Делаем правильные тени. Занимаемся освещением. Будем делать гонки! Ну или шутер, тут как ты захочешь)</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Добавим соперникам и дадим им логику. Физика и препятствия на дороге</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Закрепялем пройденный материал</span
                >
              </li>
            </ul>
          </div>
          ...
          <div class="inner p-0">
            ...
            <ul class="space-y-3">
              <li class="flex items-center">
                ...
                <span class="text-gray-400">Как работает анимация в Unity.</span>
              </li>
              <li class="flex items-center">
                <div
                  class="w-6 h-6 flex items-center justify-center bg-gray-200 text-gray-500 rounded-full mr-3"
        ...
        <div class="flex justify-between items-start">
          <div>
            <h3 class="font-semibold">
              Модуль 5: 2D-игры, ура те самые первые пиксельные игры. Эх какая настальгия!
            </h3>
            <p class="text-sm text-gray-600 dark:text-gray-100">
              7 уроков • 7 часов
            </p>
          ...
          <div class="inner p-0">
            ...
            <ul class="space-y-3">
              <li class="flex items-center">
                ...
                <span class="text-gray-400"
                  >Особенности 2D-игр в Unity</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Создаем игровое пространство</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Даём движение персонажу. Игрок: управление, поворот, атака</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Добавляем объекты, тут завист то тебя можем создать бродилку, гонки, стерелялки.</span
                >
              </li>
               <li class="flex items-center">
                <div
              ...
              <li class="flex items-center">
                ...
                <span class="text-gray-400"
                  >А теперь добавим с тобой врагов, чтобы было не скучно.</span
                >
              </li>
              <li class="flex items-center">
                <div
                ...
                <span class="text-gray-400"
                  >Выкладывам игру в сеть и Закрепляем пройденный материал.</span
                >
              </li>
            </ul>
          </div>
